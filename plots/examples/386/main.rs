...
fn art(opts: Opts) -> Vec<Group> {
    ...
    let min_scale = rng.gen_range(0.8, 5.) * rng.gen_range(0.0, 1.0);
    let max_scale = rng.gen_range(5., 80.) * rng.gen_range(0.0, 1.0);
        ...
        .map(|cin| {
            ...
            circles
                ...
                .flat_map(|c| {
                    ...
                    }, (6. * c.r) as usize, (40. + c.r.powf(pow)) as usize, &mut rng);
