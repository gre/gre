...
fn art(opts: Opts) -> Vec<Group> {
  ...
  for (i, color) in colors.iter().enumerate() {
    ...
    l = l.add(signature(0.8, (150.0, 250.0), color));
    layers.push(l);
  }
  layers
}
...
#[clap()]
struct Opts {
  #[clap(short, long, default_value = "images/man_jump.jpg")]
  path: String,
  ...
  pow: f64,
  #[clap(short, long, default_value = "8.8")]
  noise_angle_freq: f64,
  #[clap(short, long, default_value = "20.8")]
