...
pub struct Opts {
  ...
  file: String,
  #[clap(short, long, default_value = "/Users/grenaudeau/Desktop/farmer.gif")]
  animation: String,
...
fn art(opts: &Opts) -> Vec<Group> {
  ...
  for rev in 0..2 {
    let dy = (opts.height - size * 2.) / 2.0 + rev as f64 * size;
    for i in 0..frames {
      let get_color = image_gif_get_color(opts.animation.as_str(), i).unwrap();
