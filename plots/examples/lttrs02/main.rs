...
pub struct Opts {
  ...
  #[clap(
    ...
    // default_value = "aalaa bblbb cclcc ddldd eelee fflff gglgg hhlhh iilii jjljj kklkk lllll mmlmm nnlnn ooloo pplpp qqlqq rrlrr sslss ttltt uuluu vvlvv wwlww xxlxx yylyy zzlzz"
  )]
  pub sentence: String,
}
