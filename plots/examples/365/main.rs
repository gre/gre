...
fn art(opts: Opts) -> Vec<Group> {
  ...
  let items = circles
    ...
    .map(|circle| {
      ...
      let choice = (rng.gen_range(0.0, 1.0) * rng.gen_range(0.0, 1.0) * 4f32)
        .floor() as u8;
      match choice {
