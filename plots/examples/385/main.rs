...
fn art(opts: Opts) -> Vec<Group> {
    ...
    let pad = 10.0;
    let pad2 = 5.0;
    let colors = vec!["rgb(51,51,51)", "rgb(249,76,76)", "rgb(0,183,249)", "rgb(170,107,191)", "rgb(114,140,178)", "rgb(255,102,191)", "rgb(255,178,51)", "rgb(255,107,12)", "rgb(0,153,153)"];
    ...
    colors
        ...
        .map(|(ci, color)| {
            ...
            for i in 0..count {
                ...
                let dy = sign * 0.5 * rng.gen_range(0f64,1.).powf(0.5) * h * (1.0 - pi.powf(6.)) * (pi*4.).min(1.).powf(0.5);
