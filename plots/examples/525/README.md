...
**This plot reveals a new generator called "Field"**. The primitive presented here is the use of a spiral from which lines are thrown on a noise field. This plot had a glitch where some frames miss some lines which created the interesting and unplanned disappearing effect.
