...
fn art(opts: &Opts) -> Vec<Group> {
  ...
  vec!["cyan", "magenta", "yellow", "black"]
    ...
    .map(|(g, clr)| {
      ...
      let mut l = layer(clr).add(base_path(clr, 0.3, data).set("opacity", 0.8));
      if g == 3 {
        l = l.add(signature(
          1.0,
...
#[clap()]
struct Opts {
  #[clap(short, long, default_value = "images/pattern_02_c.png")]
  path: String,
