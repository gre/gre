...
pub struct Opts {
  ...
  pub height: f64,
  #[clap(short, long, default_value = "19.0")]
  pub seed: f64,
...
fn art(opts: &Opts) -> Vec<Group> {
  ...
  let amp1pow = rng.gen_range(1.0, 2.0);
  let freq1 = rng.gen_range(0.01, 0.03);
  ...
  loop {
    ...
    loop {
      ...
      let hba_index = (highest_by_angle.len() as f64 * (a / 2. * PI)) as usize
