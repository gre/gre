...
fn art(opts: &Opts) -> Vec<Group> {
  ...
  let max_scale =
    min_scale + rng.gen_range(0.0, 100f64) * rng.gen_range(0.8, 1.0);

  let iterations = 1000000;

  let drstart = rng.gen_range(0.7, 0.9);
  ...
  let get_color = image_get_color(
    "images/greweb_The_Flutterbee_a_small_creature_with_the_body_of_a_bumbl_1756d04b-f3e3-4a54-a018-56f8ef63fe4f.png",
  )
  .unwrap();
