...
Basically, you set a **css time properties** in a css selector _like `-moz-transition-duration: 1s;` for mozilla_. This time define the animation duration. Browser will determine the transition between this selector and a descendant selector.
