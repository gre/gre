...
- photographied back into a digital picture,
- and postprocessed back into a video that makes it an art by itself as well as each physical plot being one "edition" of that plot loop series.

> This concept recently came to me with [plot#108](/plots/108) exploration, now it's time to actually plot frames!

**So there are two creations:**

- the animation is itself a digital art => it is released as an NFT, with as many edition as there are frames.
- each individual frame is a physical art => it can be shipped to first buyer.

### Plots and NFT ?!

**Plot loop animations will be released as [Non Fungible Token (NFT)](https://www.youtube.com/watch?v=Y-i9Jsm95ro)** on [hicetnunc](https://www.hicetnunc.xyz/). It allows anyone with Tezos crypto currency to acquire this video on Tezos blockchain. Digital collectors are collecting one edition of this NFT which adds in their collection: **The NFT video is an art in itself**. On top of this, physical collectors can also claim the shipping of the physical art of the frame corresponding to the collected NFT edition (there are as many edition as there are frames plotted).

**This is an hybrid concept between a physical and digital art.** By buying a frame (by order of buy), the first buyer have the possibility to chose what happens to the physical art: either you allow me to keep it OR you can claim it (contact me on Twitter) and have me sending it anywhere in the world!

> I'm writing a bigger article about my recent NFT exploration and my art in general. I've been exploring so many ideas recently. I already sold some plots via using NFTs, I am very honored to have found some buyers 😍. They can still be found at [hic.link/greweb](https://hic.link/greweb). I'm currently burning them one after the other to expire the possibility to buy them as I will focus on these new projects.
...
**Triplanet was released in [plots#121](/plots/121).** 16 frames has been plotted with fountain pen on bristol paper (ink: Red Dragon by Diamine).
...
who is being the great plotterfiles.com. He also do a lot of great plotting art and thought about similar concept recently! [Checkout this article about his work.](https://medium.com/poptwig/artist-in-focus-maks-surguy-26277c95b197)
